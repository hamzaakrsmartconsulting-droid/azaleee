...
export default function LoiDenormandiePage() {
  ...
  useEffect(() => {
    const loadCmsContent = async () => {
      try {
        const response = await fetch(`/api/pages/content?path=/fiscalite/loi-denormandie&type=cms`);
        if (response.ok) {
  ...
  const content = cmsContent || {
      ...
      benefits: [
        {
          ...
          description: "Même réduction d'impôt que Pinel : 10,5% sur 6 ans, 13,5% sur 9 ans, 17,5% sur 12 ans",
          amount: "Jusqu'à 17,5%",
          icon: "💰"
        },
        {
          title: "Ancien avec travaux",
          description: "Investissement dans de l'ancien rénové au lieu du neuf",
          amount: "Flexibilité",
          icon: "🏘️"
        },
        {
        ...
        {
          title: "Plus-value",
          description: "Plus-value potentielle après rénovation",
          amount: "Patrimoine",
          icon: "📈"
        }
      ]
      ...
      conditions: [
        {
          ...
          items: [
            ...
            "Logement ancien construit avant 1990",
            "Surface habitable entre 9 et 150 m²",
            "Localisation en zone de revitalisation"
          ]
        },
        {
          category: "Rénovation",
    ...
    renovation: {
      title: "Types de rénovation éligibles",
      types: [
        {
          name: "Rénovation énergétique",
          description: "Isolation, chauffage, ventilation",
          avantages: "Réduction consommation énergétique",
          icon: "🌱"
        },
        {
          name: "Mise aux normes",
          description: "Électricité, plomberie, sécurité",
          avantages: "Conformité réglementaire",
          icon: "⚡"
        },
        {
          name: "Amélioration confort",
          description: "Salle de bain, cuisine, aménagements",
          avantages: "Valeur locative améliorée",
          icon: "🛁"
        },
        {
          name: "Rénovation globale",
          description: "Rénovation complète du logement",
          avantages: "Réduction d'impôt maximale",
          icon: "🔨"
        }
      ]
    },
    calculation: {
      ...
      cas_pratique: {
        ...
        description: "Achat ancien 100 000€ + travaux 50 000€ = base fiscale 150 000€ pour réduction Pinel",
        details: [
          "Base fiscale : 150 000€ (prix d'achat + travaux)",
          "Réduction calculée sur cette base totale",
          "Même taux que Pinel selon la durée choisie",
          "Investissement attractif pour investisseurs actifs"
        ]
      }
    },
    steps: {
      ...
      steps: [
        ...
        },
        {
          ...
          description: "Sélection d'un logement ancien en zone éligible"
        },
        {
          step: 3,
          title: "Évaluation des travaux",
          description: "Devis et planification des travaux de rénovation"
        },
        {
          step: 4,
        ...
        },
        {
          ...
          description: "Location du logement rénové"
        },
        {
          step: 7,
    ...
    risks: {
      ...
      risks: [
        ...
        "Coût et durée des travaux de rénovation",
    ...
    tips: {
      ...
      tips: [
        "Attractif pour investisseurs actifs ou appuyés par un bon promoteur",
        "Fiscalement efficace mais technique",
        "Choisissez des zones avec une forte demande locative",
        "Vérifiez l'état du bien avant achat",
        "Prévoyez une marge sur le budget travaux",
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
        ...
        <div className="flex items-center justify-center min-h-screen">
          <div className="text-center">
            ...
            <p className="text-gray-600 text-lg">Chargement de la loi Denormandie...</p>
          </div>
        </div>
      </div>
    );
        ...
        <div className="max-w-[1368px] mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex justify-center mb-8">
            <div className="bg-white rounded-xl shadow-lg p-6 text-center">
              ...
              <p className="text-[#112033] text-sm font-medium">Denormandie</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 lg:p-8">
            ...
            {activeTab === 'renovation' && (
              <div className="space-y-8">
                <div className="text-center mb-8">
                  <h2 className="text-[#112033] text-2xl font-semibold mb-4">
                    {content.renovation.title}
                  </h2>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {content.renovation.types.map((type, index) => (
                    <div key={index} className="bg-gradient-to-br from-[#E8F5E8] to-[#D4EDDA] rounded-lg p-6">
                      <div className="flex items-center mb-4">
            ...
            {activeTab === 'calculation' && (
              <div className="space-y-8">
                ...
                <div className="mb-8">
                  ...
                  <p className="text-[#686868] text-sm mb-6">Pour un logement de 100 000€ + 50 000€ de travaux = 150 000€ de base fiscale</p>
        ...
        <div className="max-w-[1368px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl shadow-xl p-8 lg:p-12 text-center">
            <h2 className="text-[#112033] text-2xl lg:text-3xl font-semibold mb-4">
              Investir dans la rénovation avec la loi Denormandie ?
            </h2>
            <p className="text-[#686868] text-lg mb-8 max-w-3xl mx-auto">
              Nos experts vous accompagnent dans votre projet de rénovation urbaine
            </p>
