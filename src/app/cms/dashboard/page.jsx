    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          {/* Retraite Spécialisée */}
          <div className="bg-white rounded-3xl shadow-2xl p-8 lg:col-span-2 border border-gray-100 hover:shadow-3xl transition-all duration-300">
            <div className="flex items-center mb-6">
              <div className="w-16 h-16 bg-gradient-to-r from-green-500 to-teal-600 rounded-2xl flex items-center justify-center mr-4 shadow-lg">
                <ClockIcon className="w-8 h-8 text-white" />
              </div>
              <div>
                <h3 className="text-2xl font-bold text-gray-900">Pages Retraite Spécialisées</h3>
                <p className="text-gray-600">Gestion Avancée de la Retraite</p>
              </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <button 
                onClick={() => router.push('/cms/retraite/plan-retraite')}
                className="w-full text-left p-4 border-2 border-gray-200 rounded-xl hover:border-green-300 hover:bg-gradient-to-r hover:from-green-50 hover:to-teal-50 transition-all duration-300 group"
              >
                <div className="font-bold text-gray-900">Plan Retraite</div>
                <div className="text-sm text-gray-600">Gérer PER, PERP, PEE, PERCO</div>
              </button>
              <button 
                onClick={() => router.push('/cms/retraite/prevoyance-protection')}
                className="w-full text-left p-4 border-2 border-gray-200 rounded-xl hover:border-green-300 hover:bg-gradient-to-r hover:from-green-50 hover:to-teal-50 transition-all duration-300 group"
              >
                <div className="font-bold text-gray-900">Prévoyance Protection</div>
                <div className="text-sm text-gray-600">Gérer la protection familiale</div>
              </button>
              <button 
                onClick={() => router.push('/cms/retraite/rachat-trimestres')}
                className="w-full text-left p-4 border-2 border-gray-200 rounded-xl hover:border-green-300 hover:bg-gradient-to-r hover:from-green-50 hover:to-teal-50 transition-all duration-300 group"
              >
                <div className="font-bold text-gray-900">Rachat Trimestres</div>
                <div className="text-sm text-gray-600">Gérer le rachat de trimestres</div>
              </button>
              <button 
                onClick={() => router.push('/cms/retraite/simulation')}
                className="w-full text-left p-4 border-2 border-gray-200 rounded-xl hover:border-green-300 hover:bg-gradient-to-r hover:from-green-50 hover:to-teal-50 transition-all duration-300 group"
              >
                <div className="font-bold text-gray-900">Simulation Retraite</div>
                <div className="text-sm text-gray-600">Gérer les simulations</div>
              </button>
              <button 
                onClick={() => router.push('/cms/retraite/autre')}
                className="w-full text-left p-4 border-2 border-gray-200 rounded-xl hover:border-green-300 hover:bg-gradient-to-r hover:from-green-50 hover:to-teal-50 transition-all duration-300 group"
              >
                <div className="font-bold text-gray-900">Autres Solutions</div>
                <div className="text-sm text-gray-600">Gérer les solutions complémentaires</div>
              </button>
            </div>
          </div>

          {/* Patrimoine Spécialisée */}
          <div className="bg-white rounded-3xl shadow-2xl p-8 lg:col-span-2 border border-gray-100 hover:shadow-3xl transition-all duration-300">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h3 className="text-2xl font-bold text-gray-900">Pages Patrimoine Spécialisées</h3>
                <p className="text-gray-600">Gestion Avancée du Patrimoine</p>
              </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <button 
                onClick={() => router.push('/cms/patrimoine/autre')}
                className="w-full text-left p-4 border-2 border-gray-200 rounded-xl hover:border-purple-300 hover:bg-gradient-to-r hover:from-purple-50 hover:to-pink-50 transition-all duration-300 group"
              >
                <div className="font-bold text-gray-900">Autres Solutions</div>
                <div className="text-sm text-gray-600">Gérer les solutions alternatives</div>
              </button>
              <button 
                onClick={() => router.push('/cms/patrimoine/bilan')}
                className="w-full text-left p-4 border-2 border-gray-200 rounded-xl hover:border-purple-300 hover:bg-gradient-to-r hover:from-purple-50 hover:to-pink-50 transition-all duration-300 group"
              >
                <div className="font-bold text-gray-900">Bilan Patrimonial</div>
                <div className="text-sm text-gray-600">Gérer les bilans patrimoniaux</div>
              </button>
              <button 
                onClick={() => router.push('/cms/patrimoine/conseils')}
                className="w-full text-left p-4 border-2 border-gray-200 rounded-xl hover:border-purple-300 hover:bg-gradient-to-r hover:from-purple-50 hover:to-pink-50 transition-all duration-300 group"
              >
                <div className="font-bold text-gray-900">Conseils Patrimoine</div>
                <div className="text-sm text-gray-600">Gérer les conseils patrimoniaux</div>
              </button>
              <button 
                onClick={() => router.push('/cms/patrimoine/donation-gratuite')}
                className="w-full text-left p-4 border-2 border-gray-200 rounded-xl hover:border-purple-300 hover:bg-gradient-to-r hover:from-purple-50 hover:to-pink-50 transition-all duration-300 group"
              >
                <div className="font-bold text-gray-900">Donation Gratuite</div>
                <div className="text-sm text-gray-600">Gérer les donations gratuites</div>
              </button>
              <button 
                onClick={() => router.push('/cms/patrimoine/donation-onereuse')}
                className="w-full text-left p-4 border-2 border-gray-200 rounded-xl hover:border-purple-300 hover:bg-gradient-to-r hover:from-purple-50 hover:to-pink-50 transition-all duration-300 group"
              >
                <div className="font-bold text-gray-900">Donation Onéreuse</div>
                <div className="text-sm text-gray-600">Gérer les donations onéreuses</div>
              </button>
              <button 
                onClick={() => router.push('/cms/patrimoine/protection-famille')}
                className="w-full text-left p-4 border-2 border-gray-200 rounded-xl hover:border-purple-300 hover:bg-gradient-to-r hover:from-purple-50 hover:to-pink-50 transition-all duration-300 group"
              >
                <div className="font-bold text-gray-900">Protection Famille</div>
                <div className="text-sm text-gray-600">Gérer la protection familiale</div>
              </button>
              <button 
                ...
                className="w-full text-left p-4 border-2 border-gray-200 rounded-xl hover:border-purple-300 hover:bg-gradient-to-r hover:from-purple-50 hover:to-pink-50 transition-all duration-300 group"
              >
                <div className="font-bold text-gray-900">Succession Heritage</div>
                <div className="text-sm text-gray-600">Gérer les successions et héritages</div>
              </button>
              <button 
                onClick={() => router.push('/cms/patrimoine/transmission')}
                className="w-full text-left p-4 border-2 border-gray-200 rounded-xl hover:border-purple-300 hover:bg-gradient-to-r hover:from-purple-50 hover:to-pink-50 transition-all duration-300 group"
              >
                <div className="font-bold text-gray-900">Transmission</div>
                <div className="text-sm text-gray-600">Gérer la transmission patrimoniale</div>
              </button>
            </div>
          </div>
        </div>
