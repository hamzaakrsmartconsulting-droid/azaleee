...
export default function CMSSCPIOPCI() {
  const [user, setUser] = useState(null);
  const [isLoading, setIsLoading] = useState(true);
  const [content, setContent] = useState({
    title: "SCPI OPCI - Société Civile de Placement Immobilier",
    subtitle: "Investir dans l'immobilier sans contraintes",
    description: "Les SCPI (Sociétés Civiles de Placement Immobilier) et OPCI (Organismes de Placement Collectif Immobilier) permettent d'investir dans l'immobilier locatif sans les contraintes de la gestion directe. Ces placements offrent une diversification et une liquidité intéressantes.",
    advantages: "• Diversification immobilière\n• Gestion professionnelle\n• Liquidité mensuelle\n• Pas de contraintes de gestion\n• Investissement à partir de 1 000€",
    fiscalBenefits: "• Revenus locatifs réguliers\n• Optimisation fiscale possible\n• Déduction des frais de gestion\n• Possibilité de déficit foncier\n• Imposition au taux réduit",
    requirements: "• Capital minimum variable\n• Respect des règles de souscription\n• Compréhension des risques\n• Horizon d'investissement long terme",
    status: "published",
    order: 2,
    showInMenu: true,
    metaTitle: "SCPI OPCI - Investissement immobilier | Diversification",
    metaDescription: "Investissez dans l'immobilier avec les SCPI et OPCI. Diversification, liquidité et conseils d'experts Azalée Patrimoine."
  });
  ...
  const handleSave = () => {
    alert("Contenu SCPI OPCI sauvegardé avec succès !");
  };

  const handlePreview = () => {
    window.open('/placements/scpi-opci', '_blank');
  };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900">SCPI OPCI</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
            ...
            <div className="mt-8">
              <button 
                onClick={handleSave}
                className="w-full bg-gradient-to-r from-purple-500 to-purple-600 text-white py-3 px-6 rounded-xl hover:from-purple-600 hover:to-purple-700 transition-all duration-200 font-medium"
              >
