...
export default function CMSAssuranceVie() {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900">Assurance Vie</h1>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-lg opacity-90">
                Gérez le contenu de la page assurance vie
              </p>
            </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <input
                  ...
                  placeholder="Titre de la page assurance vie"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  rows={6}
                  className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  placeholder="Description de l'assurance vie..."
                />
              </div>
