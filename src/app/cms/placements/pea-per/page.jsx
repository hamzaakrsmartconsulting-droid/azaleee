...
export default function CMSPEAPER() {
  const [user, setUser] = useState(null);
  const [isLoading, setIsLoading] = useState(true);
  const [content, setContent] = useState({
    title: "PEA PER - Plan d'Épargne en Actions",
    subtitle: "Investir en bourse avec avantages fiscaux",
    description: "Le PEA (Plan d'Épargne en Actions) et le PER (Plan d'Épargne Retraite) sont des enveloppes fiscales permettant d'investir en bourse avec des avantages fiscaux significatifs. Ces dispositifs permettent d'optimiser la fiscalité de vos investissements financiers.",
    advantages: "• Avantages fiscaux sur les plus-values\n• Diversification des investissements\n• Flexibilité des versements\n• Possibilité de retrait anticipé\n• Optimisation fiscale",
    fiscalBenefits: "• Exonération des plus-values après 5 ans\n• Déduction des versements (PER)\n• Imposition réduite des revenus\n• Optimisation de l'impôt sur le revenu\n• Report d'imposition possible",
    requirements: "• Respect des plafonds de versement\n• Conditions d'âge pour le PER\n• Respect des règles de retrait\n• Diversification obligatoire",
    status: "published",
    order: 1,
    showInMenu: true,
    metaTitle: "PEA PER - Plan d'Épargne Actions | Avantages fiscaux",
    metaDescription: "Découvrez le PEA et PER : investir en bourse avec avantages fiscaux. Optimisation fiscale et conseils d'experts Azalée Patrimoine."
  });
  ...
  const handleSave = () => {
    alert("Contenu PEA PER sauvegardé avec succès !");
  };

  const handlePreview = () => {
    window.open('/placements/pea-per', '_blank');
  };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center">
              <button
                onClick={() => router.push('/cms/placements')}
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900">PEA PER</h1>
          ...
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-3xl font-bold mb-2">
                PEA PER - Plan d'Épargne en Actions
              </h2>
              <p className="text-lg opacity-90">
                Investir en bourse avec avantages fiscaux
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
            ...
            <div className="mt-8">
              <button 
                onClick={handleSave}
                className="w-full bg-gradient-to-r from-green-500 to-green-600 text-white py-3 px-6 rounded-xl hover:from-green-600 hover:to-green-700 transition-all duration-200 font-medium"
              >
