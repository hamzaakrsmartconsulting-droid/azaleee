...
export default function CMSScellier() {
  const [user, setUser] = useState(null);
  const [isLoading, setIsLoading] = useState(true);
  const [content, setContent] = useState({
    title: "Dispositif Scellier",
    subtitle: "Investissement locatif avec avantages fiscaux",
    description: "Le dispositif Scellier permet de bénéficier d'une réduction d'impôt lors de l'acquisition d'un logement neuf destiné à la location. Ce dispositif fiscal avantageux s'adresse aux contribuables souhaitant investir dans l'immobilier locatif tout en réduisant leur imposition.",
    advantages: "• Réduction d'impôt de 13% du prix d'acquisition\n• Investissement dans l'immobilier neuf\n• Location obligatoire pendant 9 ans\n• Plafond de 300 000€ par logement\n• Possibilité de cumuler avec d'autres dispositifs",
    fiscalBenefits: "• Réduction d'impôt étalée sur 9 ans\n• Déduction des intérêts d'emprunt\n• Amortissement du bien\n• Optimisation fiscale significative",
    requirements: "• Acquisition d'un logement neuf\n• Mise en location dans les 12 mois\n• Respect des plafonds de loyers\n• Engagement de location de 9 ans",
    status: "published",
    order: 1,
    showInMenu: true,
    metaTitle: "Dispositif Scellier - Investissement locatif avec réduction d'impôt",
    metaDescription: "Découvrez le dispositif Scellier : investissement locatif avec réduction d'impôt de 13%. Avantages fiscaux, conditions et conseils d'experts Azalée Patrimoine."
  });
  ...
  const handlePreview = () => {
    window.open('/immobilier/scellier', '_blank');
  };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900">Scellier</h1>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-lg opacity-90">
                Investissement locatif avec réduction d'impôt de 13%
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
            ...
            <div className="mt-8">
              <button 
                onClick={handleSave}
                className="w-full bg-gradient-to-r from-red-500 to-red-600 text-white py-3 px-6 rounded-xl hover:from-red-600 hover:to-red-700 transition-all duration-200 font-medium"
              >
