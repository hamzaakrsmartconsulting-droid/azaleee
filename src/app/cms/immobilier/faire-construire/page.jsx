...
export default function CMSFaireConstruire() {
  const [user, setUser] = useState(null);
  const [isLoading, setIsLoading] = useState(true);
  const [content, setContent] = useState({
    title: "Faire Construire",
    subtitle: "Construire sa maison individuelle",
    description: "Faire construire sa maison individuelle permet de créer un logement parfaitement adapté à vos besoins et à votre budget. Ce projet nécessite une approche méthodique et des conseils d'experts pour éviter les pièges.",
    advantages: "• Maison sur mesure selon vos besoins\n• Choix du terrain et de l'emplacement\n• Personnalisation complète\n• Garanties constructeur\n• Possibilité de financement adapté",
    fiscalBenefits: "• TVA réduite à 5,5% (résidence principale)\n• Déduction des intérêts d'emprunt\n• Exonération temporaire de taxe foncière\n• Possibilité de cumuler avec PTZ",
    requirements: "• Terrain constructible\n• Budget adapté au projet\n• Respect des règles d'urbanisme\n• Contrat de construction",
    status: "published",
    order: 5,
    showInMenu: true,
    metaTitle: "Faire Construire - Maison individuelle | Conseils experts",
    metaDescription: "Conseils pour faire construire votre maison individuelle. Étapes, budget, financement et accompagnement avec Azalée Patrimoine."
  });
  ...
  const handleSave = () => {
    alert("Contenu Faire Construire sauvegardé avec succès !");
  };

  const handlePreview = () => {
    window.open('/immobilier/faire-construire', '_blank');
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900">Faire Construire</h1>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Welcome Section */}
        <div className="bg-gradient-to-r from-pink-500 to-pink-600 rounded-2xl shadow-xl p-8 mb-8 text-white">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
            ...
            <div className="mt-8">
              <button 
                onClick={handleSave}
                className="w-full bg-gradient-to-r from-pink-500 to-pink-600 text-white py-3 px-6 rounded-xl hover:from-pink-600 hover:to-pink-700 transition-all duration-200 font-medium"
              >
