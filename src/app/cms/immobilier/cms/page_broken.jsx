  ...
  const immobilierSections = [
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'wealthAdvisorText', label: 'Texte Conseiller Patrimoine', type: 'textarea' },
        { key: 'wealthAssessmentTitle', label: 'Titre Bilan Patrimonial', type: 'text' },
        { key: 'wealthAssessmentText', label: 'Texte Bilan Patrimonial', type: 'textarea' },
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'riskAnticipation', label: 'Anticipation des Risques', type: 'textarea' },
        ...
        {expertises.map((expertise, index) => (
          <div key={index} className="flex items-center gap-3 p-3 border border-gray-200 rounded-lg">
            <div className="flex-1 grid grid-cols-2 gap-3">
              ...
              <input
                type="color"
                value={expertise.bgColor || '#EDEDED'}
                onChange={(e) => {
                  const newExpertises = [...expertises];
...
export default CmsImmobilierPage;