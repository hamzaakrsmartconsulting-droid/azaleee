...
export default function CMSLoiCosse() {
  ...
  const handleSave = async () => {
    ...
    try {
      const response = await fetch('/api/cms/content/loi-cosse', {
        method: 'POST',
        headers: {
  ...
  const addArrayItem = (section, field) => {
    const sectionConfig = loiCosseSections[section];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-lg shadow-lg p-6">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">CMS - Loi Cosse</h1>
              <p className="text-gray-600">Gérez le contenu de la page Loi Cosse</p>
            </div>
            <div className="flex gap-4">
              <button
                onClick={() => router.push('/fiscalite/loi-cosse')}
          ...
          <div className="space-y-8">
            {Object.entries(loiCosseSections).map(([sectionKey, sectionConfig]) => (
