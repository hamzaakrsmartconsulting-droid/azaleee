...
export default function FiscaliteCMS() {
  ...
  // Fiscalité sections configuration - BASED ON REAL PAGE CONTENT
  const fiscaliteSections = [
    ...
    },
    {
      ...
      fields: [
        { key: 'leftItems', label: 'Sujets fiscaux', type: 'leftItems' },
        { key: 'boxes', label: 'Services', type: 'boxes' }
      ]
    },
    {
      id: 'lli',
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'cities', label: 'Villes', type: 'cities' }
      ]
    },
    {
      id: 'example',
      ...
      fields: [
        ...
        { key: 'bullets', label: 'Liste des Avantages', type: 'bullets' },
        { key: 'image', label: 'Image', type: 'text' }
      ]
    }
  ];
  ...
  const renderLeftItems = (field, value) => {
          ...
          <div key={index} className="flex items-center gap-3 p-3 border border-gray-200 rounded-lg">
            <div className="flex-1">
              <input
                ...
                placeholder="Sujet fiscal (ex: Impôt sur le revenu)"
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            onClick={() => {
              ...
              handleInputChange(field.key, newBoxes);
            }}
            className="flex items-center gap-2 px-3 py-1 bg-blue-500 text-white rounded-md hover:bg-blue-600 transition-colors"
          >
            <PlusIcon className="w-4 h-4" />
          ...
          <div key={index} className="flex items-center gap-3 p-3 border border-gray-200 rounded-lg">
            <div className="flex-1">
              <input
                ...
                placeholder="Service (ex: Optimisation fiscale personnalisée)"
                className="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
            </div>
            <button
  ...
  const renderCities = (field, value) => {
    ...
    return (
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <label className="block text-sm font-medium text-gray-700">
            Villes d'Investissement
          </label>
          <button
            type="button"
            onClick={() => {
              const newCities = [...cities, { name: '', points: [] }];
              handleInputChange(field.key, newCities);
            }}
            className="flex items-center gap-2 px-3 py-1 bg-blue-500 text-white rounded-md hover:bg-blue-600 transition-colors"
          >
            <PlusIcon className="w-4 h-4" />
        ...
        {cities.map((city, index) => (
          <div key={index} className="p-4 border border-gray-200 rounded-lg">
            <div className="flex items-center justify-between mb-3">
              <h4 className="font-medium text-gray-900">Ville {index + 1}</h4>
              <button
                type="button"
                onClick={() => {
            ...
            <input
              ...
              className="w-full mb-3 p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            />
              ...
              {(city.points || []).map((point, pointIndex) => (
                <div key={pointIndex} className="flex items-center gap-2">
                  <input
                    ...
                    onChange={(e) => {
                      const newCities = [...cities];
                      newCities[index].points[pointIndex] = e.target.value;
                      handleInputChange(field.key, newCities);
                    }}
                  ...
                  <button
                    ...
                    onClick={() => {
                      const newCities = [...cities];
                      newCities[index].points.splice(pointIndex, 1);
                      handleInputChange(field.key, newCities);
                    }}
  ...
  const renderBullets = (field, value) => {
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            onClick={() => {
              ...
              handleInputChange(field.key, newBullets);
            }}
            className="flex items-center gap-2 px-3 py-1 bg-blue-500 text-white rounded-md hover:bg-blue-600 transition-colors"
          >
            <PlusIcon className="w-4 h-4" />
  ...
  const loadSections = async () => {
    try {
      ...
      // Always use comprehensive default content that matches the REAL fiscalité page
      ...
      case 'textarea':
        return (
          <textarea
            ...
            rows={field.key.includes('html') ? 6 : 3}
            placeholder={`Saisissez ${field.label.toLowerCase()}...`}
          />
        );
      case 'leftItems':
        return renderLeftItems(field, value);
      case 'boxes':
        return renderBoxes(field, value);
      case 'cities':
        return renderCities(field, value);
      case 'bullets':
        return renderBullets(field, value);
      default:
        return (
          <input
            type={field.type}
          ...
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 font-medium">Gestion de contenu fiscal moderne et intuitive</p>
              </div>
            </div>
