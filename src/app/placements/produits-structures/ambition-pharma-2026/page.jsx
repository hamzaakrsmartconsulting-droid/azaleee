        ...
        <div className="max-w-[1368px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-white/90 text-lg sm:text-xl max-w-3xl mx-auto">
              JANVIER 2026 - Exposition à la santé et aux biotechnologies
            </p>
            ...
            <div className="bg-white rounded-xl shadow-lg border-2 border-[#B99066] p-8">
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <p className="text-[#4B5563]">
                  Le rendement de 10 % par an est versé si l'indice reste au-dessus de 50 % de son niveau initial. 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-gradient-to-br from-[#253F60]/10 to-[#B99066]/10 rounded-xl p-6 border-l-4 border-[#B99066]">
                ...
                <ul className="list-disc list-inside text-[#4B5563] space-y-1">
                  <li>Risque de perte partielle du capital si indice &lt; 50 % à l'échéance</li>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-green-500">
                <h3 className="text-[#253F60] font-bold text-lg mb-3 flex items-center gap-2">
                  <span className="text-green-500">✓</span> Secteur défensif et résilient
                </h3>
                <p className="text-[#4B5563]">
                  Le secteur de la santé et des biotechnologies est traditionnellement défensif et résilient, 
                  offrant une stabilité dans les portefeuilles.
                </p>
              </div>
              <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-green-500">
                <h3 className="text-[#253F60] font-bold text-lg mb-3 flex items-center gap-2">
                  <span className="text-green-500">✓</span> Rendement cible élevé (10 %/an)
                </h3>
                <p className="text-[#4B5563]">
                  Un rendement de 10 % par an, supérieur à la moyenne des produits structurés, 
                  pour une performance attractive.
                </p>
              </div>
              <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-green-500">
                <h3 className="text-[#253F60] font-bold text-lg mb-3 flex items-center gap-2">
                  <span className="text-green-500">✓</span> Protection renforcée du capital
                </h3>
                <p className="text-[#4B5563]">
          ...
          <div className="mb-12">
            ...
            <div className="bg-amber-50 border-l-4 border-amber-500 rounded-xl p-8">
              <div className="space-y-4">
                <div>
                  <h3 className="text-[#253F60] font-bold text-lg mb-2">⚠️ Risque de perte partielle du capital</h3>
                  <p className="text-[#4B5563]">
                    Risque de perte partielle du capital si l'indice baisse de plus de 50 % à l'échéance. 
                    Le capital n'est pas garanti en cas de forte baisse du secteur pharmaceutique.
                  </p>
                </div>
                <div>
                  <h3 className="text-[#253F60] font-bold text-lg mb-2">⚠️ Risque sectoriel (pharma/biotech)</h3>
                  <p className="text-[#4B5563]">
                    Le secteur pharmaceutique et biotechnologique peut être soumis à des risques spécifiques : 
                    échecs d'essais cliniques, réglementation, concurrence, etc.
                  </p>
                </div>
                <div>
                  <h3 className="text-[#253F60] font-bold text-lg mb-2">⚠️ Risque de liquidité avant échéance</h3>
                  <p className="text-[#4B5563]">
                    Le produit est conçu pour être détenu jusqu'à l'échéance. Une sortie anticipée peut 
                    entraîner des pertes ou des frais.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mb-12">
            ...
            <div className="bg-gradient-to-br from-[#253F60] to-[#1a2d47] rounded-2xl p-10 text-white shadow-2xl">
              <p className="text-xl sm:text-2xl leading-relaxed font-light mb-6">
                Le secteur de la santé et des biotechnologies est un pilier essentiel de l'économie mondiale, 
                avec une croissance structurelle portée par le vieillissement de la population, l'innovation 
                médicale et les besoins croissants en soins de santé.
              </p>
              <p className="text-lg leading-relaxed">
                Avec un rendement de 10 % par an et une protection du capital jusqu'à 50 % de baisse, ce produit 
                s'adresse aux investisseurs souhaitant combiner performance et sécurité dans un secteur défensif 
                et résilient, avec une durée d'investissement de 8 ans.
              </p>
            </div>
          </div>
