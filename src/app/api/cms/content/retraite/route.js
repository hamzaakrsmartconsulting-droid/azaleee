...
export async function GET() {
  try {
    ...
    console.error('Error fetching retraite CMS content:', error);
    return NextResponse.json({
      success: false,
...
export async function POST(request) {
  try {
    ...
    const checkQuery = `
      ...
      WHERE page_slug = 'retraite' AND section_name = ?
    `;
    ...
    console.error('Error saving retraite CMS content:', error);
    return NextResponse.json({
      success: false,
...
export async function DELETE(request) {
  try {
    ...
    console.error('Error deleting retraite CMS content:', error);
    return NextResponse.json({
      success: false,
