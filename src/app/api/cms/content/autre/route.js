...
export async function GET() {
  try {
    ...
    console.error('Error fetching autre CMS content:', error);
    return NextResponse.json({
      success: false,
...
export async function POST(request) {
  try {
    ...
    const checkQuery = `
      ...
      WHERE page_slug = 'autre' AND section_name = ?
    `;
    ...
    console.error('Error saving autre CMS content:', error);
    return NextResponse.json({
      success: false,
...
export async function DELETE(request) {
  try {
    ...
    console.error('Error deleting autre CMS content:', error);
    return NextResponse.json({
      success: false,
