...
export async function GET() {
  try {
    ...
    console.error('Error fetching simulation CMS content:', error);
    return NextResponse.json({
      success: false,
...
export async function POST(request) {
  try {
    ...
    const checkQuery = `
      ...
      WHERE page_slug = 'simulation' AND section_name = ?
    `;
    ...
    console.error('Error saving simulation CMS content:', error);
    return NextResponse.json({
      success: false,
...
export async function DELETE(request) {
  try {
    ...
    console.error('Error deleting simulation CMS content:', error);
    return NextResponse.json({
      success: false,
