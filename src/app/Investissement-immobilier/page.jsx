          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-start">
            ...
            <div className="w-full lg:w-[733px] bg-white rounded-lg shadow-lg p-6 sm:p-8 lg:p-10">
              ...
              <h1 className="text-black text-2xl sm:text-3xl lg:text-4xl font-cairo font-semibold leading-tight mb-6 sm:mb-8">
                Investissement Immobilier – Faites fructifier votre patrimoine avec Azalee Wealth
              </h1>
              
              {/* Description */}
              <p className="text-[#374151] text-sm sm:text-base lg:text-lg font-inter leading-relaxed mb-8 sm:mb-10">
                Votre partenaire de confiance en stratégie immobilière depuis plus de 30 ans. Nous vous accompagnons pour valoriser votre patrimoine, sécuriser vos investissements, et bâtir des solutions d'investissement sur mesure, adaptées à vos objectifs.
              </p>
        ...
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12 sm:mb-16 lg:mb-20">
            <h2 className="text-black text-xs sm:text-2xl lg:text-4xl font-cairo font-semibold leading-tight">
              Une approche stratégique de votre investissement immobilier
            </h2>
          </div>

          {/* Services Grid */}
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6 lg:gap-8">
            {/* Service Card 1 - Analysis */}
            <div className="bg-[#253F60] rounded-lg shadow-lg overflow-hidden">
              <div className="relative">
                <img
                  src="/images/investissement-immobilier-responsive-analysis-image-45db43.png"
              ...
              <div className="p-2 sm:p-4 lg:p-6">
                <h3 className="text-white text-xs sm:text-lg lg:text-xl font-inter font-semibold leading-tight mb-2 sm:mb-4">
                ...
                <p className="text-white text-xs sm:text-sm lg:text-base font-inter leading-relaxed">
                  Nous évaluons votre profil investisseur, vos objectifs de rendement et vos projets pour identifier les meilleures opportunités d'investissement immobilier.
                </p>
              </div>
            </div>

            {/* Service Card 2 - Tax Optimization */}
            <div className="bg-[#EDEDED] rounded-lg shadow-lg overflow-hidden">
              <div className="relative">
                <img
                  src="/images/investissement-immobilier-responsive-tax-image-74349c.png"
              ...
              <div className="p-2 sm:p-4 lg:p-6">
                <h3 className="text-[#1F2937] text-xs sm:text-lg lg:text-xl font-inter font-semibold leading-tight mb-2 sm:mb-4">
                  Optimisation fiscale de vos investissements immobiliers
                </h3>
                <p className="text-[#374151] text-xs sm:text-sm lg:text-base font-inter leading-relaxed">
                  Nous structurons vos opérations immobilières afin d'optimiser la rentabilité et les avantages fiscaux, en intégrant dispositifs légaux et stratégies patrimoniales.
                </p>
              </div>
            </div>
            ...
            <div className="bg-[#EDEDED] rounded-lg shadow-lg overflow-hidden">
              <div className="relative">
                <img
                  src="/images/investissement-immobilier-responsive-management-image-67c728.png"
              ...
              <div className="p-2 sm:p-4 lg:p-6">
                <h3 className="text-[#1F2937] text-xs sm:text-lg lg:text-xl font-inter font-semibold leading-tight mb-2 sm:mb-4">
                  Accompagnement global sur la gestion et la fiscalité
                </h3>
                <p className="text-[#374151] text-xs sm:text-sm lg:text-base font-inter leading-relaxed">
                  Nos experts vous accompagnent dans la structuration, la gestion juridique et fiscale, ainsi que dans la déclaration de vos investissements, en toute conformité.
                </p>
              </div>
            </div>

            {/* Service Card 4 - Strategy */}
            <div className="bg-[#EDEDED] rounded-lg shadow-lg overflow-hidden">
              <div className="relative">
                <img
                  src="/images/investissement-immobilier-responsive-strategy-image-6274ef.png"
              ...
              <div className="p-2 sm:p-4 lg:p-6">
                <h3 className="text-[#1F2937] text-xs sm:text-lg lg:text-xl font-inter font-semibold leading-tight mb-2 sm:mb-4">
                  Stratégie patrimoniale intégrée projets immobiliers
                </h3>
                <p className="text-[#374151] text-xs sm:text-sm lg:text-base font-inter leading-relaxed">
                  Nous alignons vos investissements immobiliers avec votre stratégie globale de patrimoine pour sécuriser vos actifs, anticiper la transmission et optimiser la fiscalité successorale.
                </p>
              </div>
            </div>
          </div>
