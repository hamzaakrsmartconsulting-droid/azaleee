          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="ml-3 space-y-0.5">
                    ...
                    <div className="ml-3 space-y-0.5">
                      ...
                      <p className="text-xs text-[#686868]">b- Financer l'opération par un prêt immobilier sans apport. <span className="text-[#005C69]">(Page 3)</span></p>
                      <p className="text-xs text-[#686868]">c. Préparer sa déclaration fiscale. <span className="text-[#005C69]">(Page 4)</span></p>
                      <p className="text-xs text-[#686868]">d. Investir : une démarche claire en 10 étapes. <span className="text-[#005C69]">(Page 4)</span></p>
                    </div>
                ...
                <div>
                  ...
                  <div className="ml-3 space-y-0.5">
                    ...
                    <div className="ml-3 space-y-0.5">
                      ...
                      <p className="text-xs text-[#686868]">c. Les avantages de la défiscalisation en loi Girardin. <span className="text-[#005C69]">(Page 8)</span></p>
                      <p className="text-xs text-[#686868]">d. Les conditions du dispositif de défiscalisation en loi Girardin. <span className="text-[#005C69]">(Page 8)</span></p>
                    </div>
                  </div>
                </div>
                ...
                {/* 4. NUE-PROPRIÉTÉ */}
                <div>
                  <h3 className="text-base font-semibold text-[#112033] mb-1">4. LE GUIDE DE LA NUE-PROPRIÉTÉ. <span className="text-[#005C69]">(Page 9)</span></h3>
                  <div className="ml-3 space-y-0.5">
                    <p className="text-sm text-[#374151]">4-1 LES ORIGINES DU DISPOSITIF NUE-PROPRIÉTÉ. <span className="text-[#005C69]">(Page 9)</span></p>
                    <div className="ml-3 space-y-0.5">
                      <p className="text-xs text-[#686868]">a- Pourquoi investir en nue-propriété ? <span className="text-[#005C69]">(Page 9)</span></p>
                      <p className="text-xs text-[#686868]">b. Les grands principes de la nue-propriété. <span className="text-[#005C69]">(Page 10)</span></p>
                      <p className="text-xs text-[#686868]">c. Les avantages de la défiscalisation en nue-propriété. <span className="text-[#005C69]">(Page 10)</span></p>
                      <p className="text-xs text-[#686868]">d. Les conditions du dispositif de défiscalisation en nue-propriété. <span className="text-[#005C69]">(Page 10)</span></p>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="ml-3 space-y-0.5">
                    ...
                    <div className="ml-3 space-y-0.5">
                      ...
                      <p className="text-xs text-[#686868]">b- Comprendre la défiscalisation en Monuments Historiques. <span className="text-[#005C69]">(Page 12)</span></p>
                      <p className="text-xs text-[#686868]">c- Les avantages de la défiscalisation en Monuments Historiques. <span className="text-[#005C69]">(Page 12)</span></p>
                      <p className="text-xs text-[#686868]">d- Les conditions du dispositif de défiscalisation en Monuments Historiques. <span className="text-[#005C69]">(Page 13)</span></p>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="ml-3 space-y-0.5">
                    ...
                    <div className="ml-3 space-y-0.5">
                      ...
                      <p className="text-xs text-[#686868]">c- Les avantages de la défiscalisation en loi Malraux. <span className="text-[#005C69]">(Page 15)</span></p>
                      <p className="text-xs text-[#686868]">d- Les conditions du dispositif de défiscalisation en loi Malraux. <span className="text-[#005C69]">(Page 15)</span></p>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="ml-3 space-y-0.5">
                    ...
                    <div className="ml-3 space-y-0.5">
                      ...
                      <p className="text-xs text-[#686868]">d- Les conditions de défiscalisation en LMP. <span className="text-[#005C69]">(Page 18)</span></p>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="ml-3 space-y-0.5">
                    ...
                    <div className="ml-3 space-y-0.5">
                      ...
                      <p className="text-xs text-[#686868]">c- La réduction Censi-Bouvard. <span className="text-[#005C69]">(Page 20)</span></p>
                      <p className="text-xs text-[#686868]">d- Les avantages du LMNP. <span className="text-[#005C69]">(Page 21)</span></p>
                      <p className="text-xs text-[#686868]">e- Les conditions de défiscalisation en LMNP. <span className="text-[#005C69]">(Page 21)</span></p>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="ml-3 space-y-0.5">
                    ...
                    <div className="ml-3 space-y-0.5">
                      ...
                      <p className="text-xs text-[#686868]">c- Les avantages de la défiscalisation en loi Denormandie. <span className="text-[#005C69]">(Page 23)</span></p>
                      <p className="text-xs text-[#686868]">d- Les conditions du dispositif de défiscalisation en loi Denormandie. <span className="text-[#005C69]">(Page 24)</span></p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-6">
                {/* 11. DÉFICIT FONCIER */}
                <div>
                  <h3 className="text-base font-semibold text-[#112033] mb-1">11. DÉFICIT FONCIER. <span className="text-[#005C69]">(Page 26)</span></h3>
                  <div className="ml-3 space-y-0.5">
                    <p className="text-sm text-[#374151]">11-1 Pourquoi faire du déficit foncier ?. <span className="text-[#005C69]">(Page 26)</span></p>
                    <p className="text-sm text-[#374151]">11-2 Les grands principes du déficit foncier. <span className="text-[#005C69]">(Page 26)</span></p>
                    <p className="text-sm text-[#374151]">11-3 Les avantages de défiscaliser grâce au déficit foncier. <span className="text-[#005C69]">(Page 27)</span></p>
                    <p className="text-sm text-[#374151]">11-4 Les conditions pour faire du déficit foncier. <span className="text-[#005C69]">(Page 27)</span></p>
                  </div>
                </div>

                {/* 12. FIP */}
                <div>
                  <h3 className="text-base font-semibold text-[#112033] mb-1">12. FONDS D'INVESTISSEMENT DE PROXIMITÉ. <span className="text-[#005C69]">(Page 28)</span></h3>
                  <div className="ml-3 space-y-0.5">
                    ...
                    <p className="text-sm text-[#374151]">12-3 Les avantages de la défiscalisation en FIP. <span className="text-[#005C69]">(Page 29)</span></p>
                    <p className="text-sm text-[#374151]">12-4 Les conditions de souscription à un FIP. <span className="text-[#005C69]">(Page 30)</span></p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="ml-3 space-y-0.5">
                    ...
                    <p className="text-sm text-[#374151]">14-3 Les avantages de la défiscalisation en loi Girardin industriel. <span className="text-[#005C69]">(Page 33)</span></p>
                ...
                {/* 15. SCPI */}
                <div>
                  <h3 className="text-base font-semibold text-[#112033] mb-1">15. SOCIÉTÉ CIVILE DE PLACEMENT IMMOBILIER (SCPI). <span className="text-[#005C69]">(Page 34)</span></h3>
                  <div className="ml-3 space-y-0.5">
                    ...
                    <p className="text-sm text-[#374151]">15-3 Les avantages de la défiscalisation en SCPI. <span className="text-[#005C69]">(Page 35)</span></p>
                ...
                <div>
                  ...
                  <div className="ml-3 space-y-0.5">
                    ...
                    <p className="text-sm text-[#374151]">16-3 Les avantages de défiscaliser via une SOFICA. <span className="text-[#005C69]">(Page 38)</span></p>
          ...
          <div className="mb-12">
            ...
            <div className="mt-8 p-6 bg-gradient-to-r from-[#E8F4F8] to-[#F0F9FF] rounded-lg">
              <p className="text-[#005C69] font-semibold text-lg flex items-center gap-2">
                ☁️ Téléchargez le guide et profitez d'une vision claire et complète des opportunités fiscales 2025.
              </p>
            </div>
          </div>
